...
output_csv_path = 'bert_result_f.csv'
        ...
        if count == 100:
            ...
            if len(description) < 4000:
                if len(description) < 77:
                    ...
                    summary_result = summarizer(description, max_length=77, min_length=10, do_sample=False)
                    #print("1")
                ...
                first_summary = summarizer(first_part, max_length=77, min_length=10, do_sample=False)
                #print("first 1",first_summary)
                first_summary = first_summary[0]['summary_text']
                #print("first 2",first_summary)

                second_summary = summarizer(second_part, max_length=77, min_length=10, do_sample=False)
